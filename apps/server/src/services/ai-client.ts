  ...
  const messages: PromptMessage[] = [
    {
      ...
      content: [
        ...
        "Map cycle fields to exact derived source paths such as cycle.phase and cycle.nextChangeAt. Map visible statistics only to statistics.todayCount, statistics.totalCount, statistics.totalVolumeMl, and statistics.lastRecord. statistics.nextDailyResetAt is internal program state: never create a section item for it or display it. Map fan-plan display to fanPlan target/progress/reward/completed paths. Use kind=platform with profile.followerCount/profile.postCount for platform totals.",
