...
function RoleCards({ config }: { config: ConfigSnapshot }) {
  ...
  const save = useMutation({
    ...
    onSuccess: (value) => client.setQueryData(["config"], value)
  });
